...
if __name__ == '__main__':
    ...
    oe = DistAngOutliersEliminator(datafile)    
    print oe.old_distances
    print oe.old_angles    
    
    top_limits = [0.01*i for i in range(45, math.trunc(100*max(oe.old_distances)))]
    
    ''' Variances '''    
    v1, v2 = precision.precision_test(oe, top_limits, components=['d1', 'd2', 'd3'])
